...
export default function Contact() {
  ...
  return (
    <div id="contact-page" className="min-h-screen bg-stone-50 pb-20">
      <Breadcrumb items={[{ label: "Contact Customer Care" }]} />

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-10">
        
        {/* TOP INTRO CARD */}
        <section className="bg-white rounded-3xl p-6 sm:p-10 border border-stone-150 shadow-xxs max-w-3xl mx-auto text-center flex flex-col items-center mb-12">
              ...
              <div className="relative aspect-video rounded-2xl bg-stone-100 border border-stone-200 overflow-hidden flex flex-col justify-between p-4 shadow-inner">
                ...
                <div className="absolute inset-0 opacity-15 pointer-events-none text-stone-900 font-mono text-[9px] select-none p-4">
                  <div className="grid grid-cols-4 gap-4 h-full">
                    <div className="border-r border-b border-dotted" />
                    <div className="border-l border-b border-dotted" />
                    <div className="border-r border-t border-dotted animate-pulse" />
                    <div className="border-l border-t border-dotted" />
                  </div>
                </div>
          ...
          <div className="lg:col-span-7 bg-white border border-stone-150 rounded-3xl p-6 sm:p-10 shadow-xs">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-stone-50 border border-stone-200 focus:border-amber-500 px-3.5 py-3 rounded-xl text-xs outline-none font-medium text-stone-855"
                  />
                </div>
              ...
              <div>
                ...
                <select className="w-full bg-stone-50 border border-stone-200 focus:border-amber-500 px-3.5 py-3.5 rounded-xl text-xs text-stone-850 font-semibold outline-none transition-all cursor-pointer">
