...
import { Plus, Edit2, Trash2, X, ArrowUp, ArrowDown, Sparkles, Check, Save } from "lucide-react";
import { Banner } from "../../types";

interface Props {
  banners: Banner[];
  onSaveBanners: (list: Banner[]) => void;
  triggerToast: (msg: string, type: "success" | "error" | "info" | "warning") => void;
}

export default function BannersTab({ banners, onSaveBanners, triggerToast }: Props) {
  ...
  // Move Slides up/down for re-ordering
