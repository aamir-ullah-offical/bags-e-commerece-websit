...
export default function About() {
 ...
 {settings.storeName} Luxury Heritage
 </h1>
 ...
 <section className="bg-amber-500 rounded-3xl p-8 sm:p-10 text-center text-stone-950 mt-16 max-w-4xl mx-auto shadow-md border border-amber-400 flex flex-col items-center">
 ...
 <Link
 to="/shop"
 className="inline-flex items-center justify-center gap-1.5 bg-stone-950 hover:bg-stone-900 text-white font-bold py-3.5 px-8 rounded-xl text-[10px] uppercase tracking-widest transition-all"
 >
